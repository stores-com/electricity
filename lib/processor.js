 ...
 * @param {string} hash
 */
exports.hashifyUrl = function hashifyUrl(url, hash) {
    if (!url.includes('.')) {
 ...
 */
exports.parseUrlPath = function parseUrlPath(urlPath) {
 ...
 */
exports.createProcessor = function createProcessor(directory, options, watcher) {
    ...
    function urlBuilder(urlPath) {
        let file;
        const request = exports.parseUrlPath(urlPath);
        let url = urlPath;
