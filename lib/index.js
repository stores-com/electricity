...
const createAssetProcessor = require('./processor');
...
exports.static = (directory = 'public', options = {}) => {
    ...
    const processAsset = createAssetProcessor(directory, options, {
        snockets,
        buildAssetUrl,
        watchDependency: watcher ? filePath => watcher.add(filePath) : undefined
    });
    let warming;
    ...
    function buildAssetUrl(urlPath) {
